...
test(`plugin constructor requires 'id'`, t => {
	const error = t.throws(() => {
		// eslint-disable-next-line no-unused-vars
		const plugin = new Plugin({});
	});
	t.is(error.message, `Expected 'id' to be a string, got undefined`);
});

test(`'id' must contain a value`, t => {
	const error = t.throws(() => {
		// eslint-disable-next-line no-unused-vars
		const plugin = new Plugin({id: ''});
	});
	t.is(error.message, `Expected 'id' to contain a value, got ''`);
});
...
test(`'handler' method should be a function`, t => {
	const error = t.throws(() => {
		// eslint-disable-next-line no-unused-vars
		const plugin = new Plugin({id: 'test', handler: ''});
	});
...
test(`'before' method should be a function`, t => {
	const error = t.throws(() => {
		// eslint-disable-next-line no-unused-vars
		const plugin = new Plugin({id: 'test', before: ''});
	});
	t.is(error instanceof TypeError, true);
});
...
test(`'questions' property should be an array`, t => {
	const error = t.throws(() => {
		// eslint-disable-next-line no-unused-vars
		const plugin = new Plugin({id: 'test', questions: ''});
	});
	t.is(error instanceof TypeError, true);
});
